classdef GammaDistributionContainerTest < matlab.unittest.TestCase
    methods (Test)
        ...
        function testConstructorWithOneParameter(testCase)
            ...
            truePriors = [GammaDistribution(), GammaDistribution(1, 2), GammaDistribution(4, 3), NaN];
        ...
        function testConstructorWithThreeParameters(testCase)
            ...
            % b: array
            a = 1; b = [1, 2, 3, 4];
            priors = [GammaDistribution(aPrior, bPrior), NaN, NaN, NaN];
            obj = GammaDistributionContainer(a, b, priors);
            ...
            GammaDistributionTest.verifyObject(testCase, obj.distributions(1).prior, aPrior, bPrior); % First component has a not NaN prior
        end
        ...
        function testConstructorWithFourParameters(testCase)
            ...
            aPrior = 5;
            bPrior = 2;
            priors = [GammaDistribution(aPrior, bPrior), NaN, GammaDistribution(aPrior, bPrior), NaN];
