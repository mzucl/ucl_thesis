...
%% W and alpha
Visualization.plotLoadingsAndAlpha(trueW, sgfaModel.D, data.alpha, 'True $\mathbf{W}^\top$ and \boldmath{$\alpha$}$^\top$', 'top');
Visualization.plotLoadingsAndAlpha(estW, sgfaModel.D, estAlpha, 'Inferred $\mathbf{W}^\top$ and \boldmath{$\alpha$}$^\top$', 'bottom');